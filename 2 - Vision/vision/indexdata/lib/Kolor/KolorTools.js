    ...
    (function() {
        ...
        ktools.R = function(a) {
            ...
            this.supportsFullscreen = this.Sa = function() {
                ...
                f = "";
                if ("undefined" != typeof document.exitFullscreen || "undefined" != typeof document.exitFullScreen || "undefined" != typeof document.cancelFullscreen || "undefined" != typeof document.cancelFullScreen) i = k, f += "fullscreenchange";
                else
            ...
            this.request = this.La = function() {
                ...
                if (i) {
                    if (!this.D() || !this.p())
                        if ("" === c) b.requestFullscreen ? b.requestFullscreen() : b.requestFullScreen();
                        else if (b[c + "RequestFullscreen"])
                        if ("webkit" == c) b[c + "RequestFullscreen"](Element.O);
                        else b[c + "RequestFullscreen"]();
                    else if ("webkit" == c) b[c + "RequestFullScreen"](Element.O);
                    else b[c + "RequestFullScreen"]()
            ...
            this.exit = this.Y = function() {
                ...
                if (i) {
                    if (this.D() || this.p()) {
                        var a = document;
                        if ("" === c) a.exitFullscreen ? a.exitFullscreen() : a.exitFullScreen ? a.exitFullScreen() : a.cancelFullscreen ? a.cancelFullscreen() : a.cancelFullScreen();
                        else if (a[c + "ExitFullscreen"]) a[c + "ExitFullscreen"]();
                        else if (a[c + "ExitFullScreen"]) a[c + "ExitFullScreen"]();
                        else if (a[c + "CancelFullscreen"]) a[c + "CancelFullscreen"]();
                        else a[c + "CancelFullScreen"]()
                    }
        ...
        ktools.T = function(a, d, b, i) {
            ...
            this.loadScript = this.h = function(a) {
                c.G(a);
                if (c.F()) return c.s();
                if (0 == b.length) ktools.c.d().h(c.getName(), c.l(), c.s);
                else
                    for (a = 0; a < b.length; a++) b[a].h(c)
            };
